...
namespace Microsoft.ML.Trainers
{
    ...
    public abstract class SgdBinaryTrainerBase<TModelParameters> :
        ...
        where TModelParameters : class, IPredictorProducing<float>
    {
        public class SgdBinaryOptionsBase : LearnerInputBaseWithWeight
        {
        ...
        private readonly SgdBinaryOptionsBase _options;
        ...
        internal SgdBinaryTrainerBase(IHostEnvironment env,
            ...
            int maxIterations = SgdBinaryOptionsBase.Defaults.MaxIterations,
            double initLearningRate = SgdBinaryOptionsBase.Defaults.InitLearningRate,
            float l2Weight = SgdBinaryOptionsBase.Defaults.L2Weight)
            : base(env, featureColumn, TrainerUtils.MakeBoolScalarLabel(labelColumn), weightColumn)
        {
            Host.CheckNonEmpty(featureColumn, nameof(featureColumn));
            Host.CheckNonEmpty(labelColumn, nameof(labelColumn));

            _options = new SgdBinaryOptionsBase();
        ...
        internal SgdBinaryTrainerBase(IHostEnvironment env, SgdBinaryOptionsBase options, IClassificationLoss loss = null, bool doCalibration = false)
        ...
        SgdBinaryTrainerBase<CalibratedModelParametersBase<LinearBinaryModelParameters, PlattCalibrator>>
    {
        ...
        /// </summary>
        public sealed class Options : SgdBinaryOptionsBase
        {
        }
