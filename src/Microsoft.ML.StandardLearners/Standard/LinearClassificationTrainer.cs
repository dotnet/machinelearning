                    ...
                    for (int numTrials = 0; numTrials < maxUpdateTrials; numTrials++)
                    {
                        ...
                        if (success)
                        {
                            ...
                            else
                            {
                                ...
                                if (features.IsDense)
                                    CpuMathUtils.SdcaL1UpdateDense(primalUpdate, features.Values, l1Threshold, l1IntermediateWeights[0].Values, weights[0].Values);
                                else if (features.Count > 0)
                                    CpuMathUtils.SdcaL1UpdateSparse(primalUpdate, features.Values, features.Indices, features.Count, l1Threshold, l1IntermediateWeights[0].Values, weights[0].Values);
                            }
