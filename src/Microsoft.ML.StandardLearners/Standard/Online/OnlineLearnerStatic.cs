...
namespace Microsoft.ML.StaticPipe
{
    ...
    public static class AveragedPerceptronExtensions
    {
        ...
        /// <![CDATA[
        ///  [!code-csharp[SDCA](~/../docs/samples/docs/samples/Microsoft.ML.Samples/Static/AveragedPerceptron.cs?range=6-11,19-113 "The Averaged Perceptron binary classification example.")]
        /// ]]></format>
        /// </example>
