...
namespace Microsoft.Data.Analysis
{
    public partial class DataFrame
    {
        ...
        {
            private CsvLineEnumerator _enumerator;
            public CsvLines(CsvLineEnumerator csvLineEnumerator)
            {
                _enumerator = csvLineEnumerator;
            }
        ...
        private class CsvLineEnumerator : IEnumerator<string>
        {
            ...
            {
                _streamStartPosition = csvStream.BaseStream.Position;
                _streamReader = csvStream;
                _currentLine = null;
            }
            ...
            public void Reset()
            {
                ...
                _streamReader.BaseStream.Seek(_streamStartPosition, SeekOrigin.Begin);
            }
        }
