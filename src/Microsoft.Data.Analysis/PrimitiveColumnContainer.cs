...
namespace Microsoft.Data.Analysis
{
        ...
        where T : struct
    {
        ...
        internal bool ModifyNullCountWhileIndexing = true;
        ...
        private byte SetBit(byte curBitMap, int index, bool value)
        {
            ...
            if (value)
            {
                ...
                if (ModifyNullCountWhileIndexing && ((curBitMap >> (index & 7)) & 1) == 0 && index < Length && NullCount > 0)
                {
                    // Old value was null.
                    NullCount--;
                }
            ...
            {
                if (ModifyNullCountWhileIndexing && ((curBitMap >> (index & 7)) & 1) == 1 && index < Length)
                {
                    // old value was NOT null and new value is null
                    NullCount++;
                }
                else if (ModifyNullCountWhileIndexing && index == Length)
                {
