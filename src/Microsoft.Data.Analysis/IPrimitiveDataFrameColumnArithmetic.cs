...
namespace Microsoft.Data.Analysis
{
        ...
        where T : unmanaged
    {
        ...
        void HandleOperation(BinaryOperation operation, Span<T> left, T right);
        void HandleOperation(BinaryOperation operation, T left, Span<T> right, ReadOnlySpan<byte> rightValidity);
        ...
        void HandleOperation(ComparisonOperation operation, ReadOnlySpan<T> left, T right, PrimitiveColumnContainer<bool> container, long offset);
