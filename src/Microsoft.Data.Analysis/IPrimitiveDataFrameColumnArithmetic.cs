...
namespace Microsoft.Data.Analysis
{
        ...
        where T : unmanaged
    {
        ...
        Span<bool> HandleOperation(ComparisonOperation operation, ReadOnlySpan<T> left, ReadOnlySpan<T> right);
        Span<bool> HandleOperation(ComparisonScalarOperation operation, ReadOnlySpan<T> left, T right);
