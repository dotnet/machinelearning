...
namespace Microsoft.Data.Analysis
{
    ...
    public partial class StringDataFrameColumn : DataFrameColumn, IEnumerable<string>
    {
        ...
        public new StringDataFrameColumn Sort(bool ascending = true, bool nullValuesLast = true)
        {
            return (StringDataFrameColumn)base.Sort(ascending, nullValuesLast);
        }

        internal override PrimitiveDataFrameColumn<long> GetSortIndices(bool ascending, bool nullValuesLast)
        {
