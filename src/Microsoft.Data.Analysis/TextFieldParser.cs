...
[assembly: InternalsVisibleTo("Microsoft.Data.Analysis.Tests, PublicKey= ")]
...
namespace Microsoft.Data.Analysis
{
    ...
    internal class TextFieldParser : IDisposable
    {
        ...
        private char[] _buffer = new char[DefaultBufferLength];
        ...
        private char[] _newLineChars = Environment.NewLine.ToCharArray();
        ...
        private int IncreaseBufferSize()
        {
            ...
            int bufferSize = _buffer.Length + DefaultBufferLength;
            ...
            int charsRead = _reader.Read(tempArray, _buffer.Length, DefaultBufferLength);
            _buffer = tempArray;
