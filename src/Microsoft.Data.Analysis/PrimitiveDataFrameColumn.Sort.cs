...
namespace Microsoft.Data.Analysis
{
    ...
    {
        /// <inheritdoc/>
        public new PrimitiveDataFrameColumn<T> Sort(bool ascending = true, bool nullValuesLast = true)
        {
            return (PrimitiveDataFrameColumn<T>)base.Sort(ascending, nullValuesLast);
        }

        internal override PrimitiveDataFrameColumn<long> GetSortIndices(bool ascending = true, bool nullValuesLast = true)
        {
