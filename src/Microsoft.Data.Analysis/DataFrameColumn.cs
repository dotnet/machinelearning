...
namespace Microsoft.Data.Analysis
{
    ...
    public abstract partial class DataFrameColumn : IEnumerable
    {
        ...
        public DataFrameColumn Sort(bool ascending = true, bool nullValuesLast = true)
        {
            PrimitiveDataFrameColumn<long> sortIndices = GetSortIndices(ascending, nullValuesLast);
        ...
        /// <param name="ascending">Sorting order.</param>
        /// <param name="nullValuesLast">If true, null values are always put at the end.</param>
        internal abstract PrimitiveDataFrameColumn<long> GetSortIndices(bool ascending, bool nullValuesLast);
                                                            ...
                                                            GetBufferLengthAtIndex getBufferLengthAtIndex)
        {
            ...
            //Fill Nulls 
            var start = nullValuesLast ? columnSortIndices.Length - columnNullIndices.Length : 0;
