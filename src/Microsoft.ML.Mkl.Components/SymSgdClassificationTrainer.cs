...
[assembly: LoadableClass(typeof(SymbolicSgdBinaryClassificationTrainer), typeof(SymbolicSgdBinaryClassificationTrainer.Options),
    new[] { typeof(SignatureBinaryClassifierTrainer), typeof(SignatureTrainer), typeof(SignatureFeatureScorerTrainer) },
    SymbolicSgdBinaryClassificationTrainer.UserNameValue,
    SymbolicSgdBinaryClassificationTrainer.LoadNameValue,
    SymbolicSgdBinaryClassificationTrainer.ShortName)]

[assembly: LoadableClass(typeof(void), typeof(SymbolicSgdBinaryClassificationTrainer), null, typeof(SignatureEntryPointModule), SymbolicSgdBinaryClassificationTrainer.LoadNameValue)]
...
namespace Microsoft.ML.Trainers
{
    ...
    public sealed class SymbolicSgdBinaryClassificationTrainer : TrainerEstimatorBase<BinaryPredictionTransformer<TPredictor>, TPredictor>
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="SymbolicSgdBinaryClassificationTrainer"/>
        /// </summary>
        internal SymbolicSgdBinaryClassificationTrainer(IHostEnvironment env, Options options)
        ...
        /// <summary>
        /// Continues the training of <see cref="SymbolicSgdBinaryClassificationTrainer"/> using an already trained <paramref name="modelParameters"/>
        ...
        [TlcModule.EntryPoint(Name = "Trainers.SymSgdBinaryClassifier",
            ...
            UserName = SymbolicSgdBinaryClassificationTrainer.UserNameValue,
            ShortName = SymbolicSgdBinaryClassificationTrainer.ShortName)]
        internal static CommonOutputs.BinaryClassificationOutput TrainSymSgd(IHostEnvironment env, Options options)
        {
            ...
            return TrainerEntryPointsUtils.Train<Options, CommonOutputs.BinaryClassificationOutput>(host, options,
                () => new SymbolicSgdBinaryClassificationTrainer(host, options),
        ...
        private sealed class ArrayManager<T> : IDisposable
        {
            ...
            private readonly SymbolicSgdBinaryClassificationTrainer _trainer;
            ...
            /// <param name="ch"></param>
            public ArrayManager(SymbolicSgdBinaryClassificationTrainer trainer, IChannel ch)
            {
        ...
        private sealed class InputDataManager : IDisposable
        {
            ...
            public InputDataManager(SymbolicSgdBinaryClassificationTrainer trainer, FloatLabelCursor.Factory cursorFactory, IChannel ch)
            {
