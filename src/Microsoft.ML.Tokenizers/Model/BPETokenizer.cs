...
namespace Microsoft.ML.Tokenizers
{
    ...
    public sealed class BpeTokenizer : Tokenizer
    {
        ...
        public static BpeTokenizer Create(Stream vocabStream, Stream? mergesStream)
            => Create(vocabStream, mergesStream, preTokenizer: WhiteSpacePreTokenizer.Instance, normalizer: null, addedTokens: null, unknownToken: null, continuingSubwordPrefix: null, endOfWordSuffix: null, fuseUnknownTokens: false);
