...
namespace Microsoft.ML.Runtime.Model.Onnx
{
    public sealed class SaveOnnxCommand : DataCommand.ImplBase<SaveOnnxCommand.Arguments>
    {
        ...
        public sealed class Arguments : DataCommand.ArgumentsBase
        {
            ...
            [Argument(ArgumentType.AtMostOnce, HelpText = "The targeted ONNX version. It can be either \"Stable\" or \"Experimental\". If \"Experimental\" is used, models produced can contain components not officially defined in ONNX standard.", SortOrder = 11)]
