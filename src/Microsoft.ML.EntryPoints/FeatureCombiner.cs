...
namespace Microsoft.ML.EntryPoints
{
    internal static class FeatureCombiner
    {
        ...
        private static List<KeyToVectorMappingTransformer.ColumnInfo> ConvertFeatures(IEnumerable<DataSchema.Column> feats, HashSet<string> featNames, List<KeyValuePair<string, string>> concatNames, IChannel ch,
