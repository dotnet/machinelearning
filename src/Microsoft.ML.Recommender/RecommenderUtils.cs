...
namespace Microsoft.ML.Recommender
{
    internal static class RecommenderUtils
    {
        ...
        /// If the column roles, <see cref="MatrixColumnIndexKind"/> and <see cref="MatrixRowIndexKind"/>, uniquely exist in data, their <see cref="DataSchema.Column"/> would be assigned
        ...
        public static void CheckAndGetMatrixIndexColumns(RoleMappedData data, out DataSchema.Column matrixColumnIndexColumn, out DataSchema.Column matrixRowIndexColumn, bool isDecode)
        {
        ...
        private static KeyType CheckRowColumnType(RoleMappedData data, RoleMappedSchema.ColumnRole role, out DataSchema.Column col, bool isDecode)
        {
            Contracts.AssertValue(data);
