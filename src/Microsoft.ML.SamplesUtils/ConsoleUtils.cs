...
namespace Microsoft.ML.SamplesUtils
{
    ...
    public static class ConsoleUtils
    {
        ...
        public static void PrintMetrics(BinaryClassificationMetrics metrics)
        {
            ...
            Console.WriteLine($"AUC: {metrics.AreaUnderTheCurve:F2}");
        ...
        {
            Console.WriteLine($"L1: {metrics.AbsoluteLoss:F2}");
            Console.WriteLine($"L2: {metrics.SquaredLoss:F2}");
            Console.WriteLine($"LossFunction: {metrics.LossFunction:F2}");
            Console.WriteLine($"RMS: {metrics.RootMeanSquareLoss:F2}");
