...
namespace Microsoft.ML
{
    public static class ImageEstimatorsCatalog
    {
        ...
        /// <param name="offsetPixelColor">Offset pixel's color value by this amount. Applied to color value before <paramref name="scalePixelColor"/>.</param>
        /// <param name="scalePixelColor">Scale pixel's color value by this amount. Applied to color value after <paramref name="offsetPixelColor"/>.</param>
        /// <param name="outputAsFloatArray">Output array as float array. If false, output as byte array and ignores <paramref name="offsetPixelColor"/> and <paramref name="scalePixelColor"/>.</param>
        /// <example>
        /// <format type="text/markdown">
        /// <![CDATA[
        ...
        public static ImagePixelExtractingEstimator ExtractPixels(this TransformsCatalog catalog,
            ...
            float offsetPixelColor = ImagePixelExtractingEstimator.Defaults.Offset,
            float scalePixelColor = ImagePixelExtractingEstimator.Defaults.Scale,
            bool outputAsFloatArray = ImagePixelExtractingEstimator.Defaults.Convert)
            => new ImagePixelExtractingEstimator(CatalogUtils.GetEnvironment(catalog), outputColumnName, inputColumnName, colorsToExtract, orderOfExtraction, interleavePixelColors, offsetPixelColor, scalePixelColor, outputAsFloatArray);
        ...
        /// all the values for one color for all pixels, then all the values for another color and so on.</param>
        /// <param name="scalePixelColor">The values are scaled by this value before being converted to pixels. Applied to vector value before <paramref name="offsetPixelColor"/>.</param>
        /// <param name="offsetPixelColor">The offset is subtracted before converting the values to pixels. Applied to vector value <paramref name="scalePixelColor"/>.</param>
        ...
        public static VectorToImageConvertingEstimator ConvertToImage(this TransformsCatalog catalog, int imageHeight, int imageWidth, string outputColumnName, string inputColumnName = null,
            ...
            float scalePixelColor = VectorToImageConvertingEstimator.Defaults.Scale,
            float offsetPixelColor = VectorToImageConvertingEstimator.Defaults.Offset,
