                ...
                BasePredictors = new[]
                {
                    ComponentFactoryUtils.CreateFromFunction(
                        env => {
                            ...
                            var trainerEstimator = new LogisticRegressionMulticlassTrainer(env, LabelColumnName, FeatureColumnName);
                            return TrainerUtils.MapTrainerEstimatorToTrainer<LogisticRegressionMulticlassTrainer,
