...
namespace Microsoft.ML.Data
{
        ...
        where TAgg : EvaluatorBase<TAgg>.AggregatorBase
    {
        ...
        /// the input getters of the given DataViewRow that are needed for the current pass, assuming that all the needed column
        ...
        public abstract class AggregatorBase
        {
            ...
            /// <summary>
            /// This method should get the getters of the new DataViewRow that are needed for the next pass.
            /// </summary>
            [BestFriend]
        ...
        protected abstract class AggregatorDictionaryBase
        {
            ...
            /// <summary>
            /// Gets the stratification column getter for the new DataViewRow.
            /// </summary>
