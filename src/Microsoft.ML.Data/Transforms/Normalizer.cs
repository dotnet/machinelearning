...
namespace Microsoft.ML.Transforms.Normalizers
{
    ...
    public sealed partial class NormalizingTransformer : OneToOneTransformerBase
    {
        ...
        /// <summary>
        /// The model parameters generated by cumulative distribution normalization transformations, like
        ...
        /// The function a cumulative density function is parameterized by <see cref="CdfNormalizerModelParameters{TData}.Mean"/> and
        ...
        /// or methods in the <see cref="NormalizerCatalog"/> having the <see cref="NormalizingEstimator.NormalizerMode"/> parameter set to
