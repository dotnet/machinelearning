...
namespace Microsoft.ML.Data
{
    ...
    public abstract class OneToOneTransformerBase : RowToRowTransformerBase
    {
        ...
        private void CheckInput(DataSchema inputSchema, int col, out int srcCol)
        {
        ...
        protected virtual void CheckInputColumn(DataSchema inputSchema, int col, int srcCol)
        {
        ...
        protected abstract class OneToOneMapperBase : MapperBase
        {
            ...
            protected OneToOneMapperBase(IHost host, OneToOneTransformerBase parent, DataSchema inputSchema) : base(host, inputSchema, parent)
            {
