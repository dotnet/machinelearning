...
namespace Microsoft.ML.StaticPipe
{
    ...
    public static class NormalizerStaticExtensions
    {
        ...
        private static Action<IColumnFunction> AffineMapper<TData>(OnFitAffine<TData> onFit)
        {
            ...
            return col =>
            {
                var aCol = (NormalizerTransformer.AffineNormalizerModelParametersBase<TData>)col?.GetNormalizerModelParams();
        ...
        private static Action<IColumnFunction> CdfMapper<TData>(OnFitCumulativeDistribution<TData> onFit)
        {
            ...
            return col =>
            {
                var aCol = (NormalizerTransformer.CdfNormalizerModelParametersBase<TData>)col?.GetNormalizerModelParams();
        ...
        private static Action<IColumnFunction> BinMapper<TData>(OnFitBinned<TData> onFit)
        {
            ...
            return col =>
            {
                var aCol = (NormalizerTransformer.BinNormalizerModelParametersBase<TData>)col?.GetNormalizerModelParams();
