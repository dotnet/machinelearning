...
namespace Microsoft.ML.Transforms.Conversions
{
    ...
    public sealed class ValueToKeyMappingEstimator : IEstimator<ValueToKeyMappingTransformer>
    {
        ...
        public ValueToKeyMappingEstimator(IHostEnvironment env, string name, string source = null, int maxNumTerms = Defaults.MaxNumTerms, ValueToKeyMappingTransformer.SortOrder sort = Defaults.Sort) :
           this(env, new [] { new ValueToKeyMappingTransformer.ColumnInfo(name, source ?? name, maxNumTerms, sort) })
        {
        }
