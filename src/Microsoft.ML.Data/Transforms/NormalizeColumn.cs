    ...
    internal sealed partial class NormalizeTransform
    {
        ...
        internal abstract partial class CdfColumnFunction : IColumnFunction
        {
            ...
            public static CdfColumnFunction Create(ModelLoadContext ctx, IHost host, DataViewType typeSrc)
            {
                ...
                throw host.ExceptUserArg(nameof(AffineArgumentsBase.Columns), "Wrong column type. Expected: Single, Double, Vector<Single, n> or Vector<Double, n>. Got: {0}.", typeSrc);
            }
        ...
        internal abstract partial class BinColumnFunction : IColumnFunction
        {
            ...
            public static BinColumnFunction Create(ModelLoadContext ctx, IHost host, DataViewType typeSrc)
            {
                ...
                throw host.ExceptUserArg(nameof(BinArguments.Columns), "Wrong column type. Expected: Single, Double, Vector<Single, n> or Vector<Double, n>. Got: {0}.", typeSrc);
            }
        ...
        internal static partial class MinMaxUtils
        {
                ...
                int srcIndex, DataViewType srcType, DataViewRowCursor cursor)
            {
                ...
                throw host.ExceptParam(nameof(srcType), "Wrong column type for input column. Expected: Single, Double, Vector<Single, n> or Vector<Double, n>. Got: {0}.", srcType.ToString());
            }
        }
        ...
        internal static partial class LogMeanVarUtils
        {
                ...
                int srcIndex, DataViewType srcType, DataViewRowCursor cursor)
            {
                ...
                throw host.ExceptUserArg(nameof(column), "Wrong column type for column {0}. Expected: Single, Double, Vector<Single, n> or Vector<Double, n>. Got: {1}.", column.InputColumnName, srcType.ToString());
            }
        }
        ...
        internal static partial class BinUtils
        {
                ...
                int srcIndex, DataViewType srcType, DataViewRowCursor cursor)
            {
                ...
                throw host.ExceptParam(nameof(column), "Wrong column type for column {0}. Expected: Single, Double, Vector<Single, n> or Vector<Double, n>. Got: {1}.", column.InputColumnName, srcType.ToString());
            }
        }
