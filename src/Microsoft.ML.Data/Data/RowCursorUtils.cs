...
namespace Microsoft.ML.Data
{
    ...
    internal static class RowCursorUtils
    {
        ...
        /// <summary>
        /// Given a destination type, DataViewRow, and column index, return a ValueGetter for the column
        ...
        /// <summary>
        /// Given a destination type, DataViewRow, and column index, return a ValueGetter{TDst} for the column
        ...
        /// <summary>
        /// Given a DataViewRow, and column index, return a function that utilizes the
