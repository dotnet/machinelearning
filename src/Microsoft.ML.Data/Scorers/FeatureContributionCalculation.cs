...
[assembly: LoadableClass(typeof(ISchemaBindableMapper), typeof(BindableMapper), typeof(BindableMapper.Arguments),
    typeof(SignatureBindableMapper), "Feature Contribution Mapper", "fct", MetadataUtils.Const.ScoreColumnKind.FeatureContribution)]

[assembly: LoadableClass(typeof(BindableMapper), typeof(BindableMapper), null, typeof(SignatureLoadModel),
    "Feature Contribution Mapper", BindableMapper.MapperLoaderSignature)]
