...
////[assembly: LoadableClass(typeof(IDataScorerTransform), typeof(FeatureContributionCalculatingTransform.BindableMapper), typeof(FeatureContributionCalculatingTransform.BindableMapper.Arguments),
...
////[assembly: LoadableClass(typeof(ISchemaBindableMapper), typeof(FeatureContributionCalculatingTransform.BindableMapper), typeof(FeatureContributionCalculatingTransform.BindableMapper.Arguments),
////    typeof(SignatureBindableMapper), "Feature Contribution Mapper", "fct", MetadataUtils.Const.ScoreColumnKind.FeatureContribution)]

////[assembly: LoadableClass(typeof(FeatureContributionCalculatingTransform.BindableMapper), typeof(FeatureContributionCalculatingTransform.BindableMapper), null, typeof(SignatureLoadModel),
////    "Feature Contribution Mapper", FeatureContributionCalculatingTransform.BindableMapper.MapperLoaderSignature)]

////[assembly: LoadableClass(FeatureContributionCalculatingTransform.Summary, typeof(FeatureContributionCalculatingTransform), null, typeof(SignatureLoadModel),
////    FeatureContributionCalculatingTransform.FriendlyName, FeatureContributionCalculatingTransform.LoaderSignature)]

////[assembly: LoadableClass(typeof(IRowMapper), typeof(FeatureContributionCalculatingTransform), null, typeof(SignatureLoadRowMapper),
////   FeatureContributionCalculatingTransform.FriendlyName, FeatureContributionCalculatingTransform.LoaderSignature)]

////[assembly: LoadableClass(typeof(void), typeof(FeatureContributionEntryPoint), null, typeof(SignatureEntryPointModule), FeatureContributionCalculatingTransform.LoaderSignature)]
...
//    ///         FastTree, LightGbm
//    ///
//    /// See the sample below for an example of how to compute feature importance using the FeatureContributionCalculatingTransform.
//    /// </remarks>
//    /// <example>
...
//    /// </format>
//    /// </example>
//    public sealed class FeatureContributionCalculatingTransform : RowToRowTransformerBase
//    {
...
//                loaderAssemblyName: typeof(FeatureContributionCalculatingTransform).Assembly.FullName);
//        }
...
//        /// See <see cref="FeatureContributionCalculatingTransform"/> for a list of the suported predictors.
//        /// </summary>
...
//        public FeatureContributionCalculatingTransform(IHostEnvironment env, ICalculateFeatureContribution predictor,
...
//            : base(Contracts.CheckRef(env, nameof(env)).Register(nameof(FeatureContributionCalculatingTransform)))
//        {
...
//        private FeatureContributionCalculatingTransform(IHostEnvironment env, ModelLoadContext ctx)
//            : base(Contracts.CheckRef(env, nameof(env)).Register(nameof(FeatureContributionCalculatingTransform)))
//        {
...
//            => new FeatureContributionCalculatingTransform(env, ctx).MakeRowMapper(inputSchema);

//        // Used by the entrypoints.
//        internal static IDataTransform Create(IHostEnvironment env, ICalculateFeatureContribution predictor, Arguments args, IDataView input)
//            => new FeatureContributionCalculatingTransform(env, predictor, args.FeatureColumn, args.Top, args.Bottom, args.Normalize, args.Stringify).MakeDataTransform(input);
...
//        {
//            private readonly FeatureContributionCalculatingTransform _parent;
...
//            public Mapper(FeatureContributionCalculatingTransform parent, Schema schema)
...
//            // The FeatureContributionCalculatingTransform produces two sets of columns: the columns obtained from scoring and the FeatureContribution column.
...
//    ///// <summary>
//    ///// Estimator producing a FeatureContributionCalculatingTransform which scores the model on an input dataset and
//    ///// computes model-specific contribution scores for each feature.
//    ///// </summary>
//    //public sealed class FeatureContributionCalculatingEstimator : TrivialEstimator<FeatureContributionCalculatingTransform>
//    //{
//    //    private readonly string _featureColumn;
...
//    //        : base(Contracts.CheckRef(env, nameof(env)).Register(nameof(FeatureContributionCalculatingTransform)),
//    //              new FeatureContributionCalculatingTransform(env, predictor, featureColumn, top, bottom, normalize, stringify))
//    //    {
//    //        _featureColumn = featureColumn;
...
//    //        Desc = FeatureContributionCalculatingTransform.Summary,
//    //        UserName = FeatureContributionCalculatingTransform.FriendlyName)]
//    //    public static CommonOutputs.TransformOutput FeatureContributionCalculation(IHostEnvironment env, FeatureContributionCalculatingTransform.Arguments input)
//    //    {
//    //        Contracts.CheckValue(env, nameof(env));
//    //        var host = env.Register(nameof(FeatureContributionCalculatingTransform));
//    //        host.CheckValue(input, nameof(input));
//    //        EntryPointUtils.CheckInputArgs(host, input);

//    //        var predictor = input.PredictorModel.Predictor as ICalculateFeatureContribution;
//    //        if (predictor == null)
//    //            throw host.ExceptUserArg(nameof(predictor), "The provided predictor does not support feature contribution calculation.");

//    //        var xf = FeatureContributionCalculatingTransform.Create(host, predictor, input, input.Data);
