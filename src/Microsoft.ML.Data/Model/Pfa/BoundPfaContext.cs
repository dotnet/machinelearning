...
namespace Microsoft.ML.Model.Pfa
{
    ...
    internal sealed class BoundPfaContext
    {
        ...
        public BoundPfaContext(IHostEnvironment env, DataSchema inputSchema, HashSet<string> toDrop, bool allowSet)
        {
        ...
        private void SetInput(DataSchema schema, HashSet<string> toDrop)
        {
        ...
        public JObject Finalize(DataSchema schema, params string[] toOutput)
        {
        ...
        private JToken PfaTypeOrNullForColumn(DataSchema schema, int col)
        {
