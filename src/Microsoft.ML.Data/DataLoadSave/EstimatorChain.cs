...
namespace Microsoft.ML.Data
{
        ...
        where TLastTransformer : class, ITransformer
    {
        ...
        /// engineering that is slow on its apply phase. Adding a cache checkpoint at the end of an <see cref="EstimatorChain{TLastTransformer}"/>
        /// is meaningless and should be avoided. AppendCacheCheckpoint() should be disabled if disk thrashing or OutOfMemory
        /// exceptions are seen, which can occur on when the featured dataset immediately prior to the checkpoint is larger than available RAM.
        /// </summary>
