        ...
        private sealed class Bindings
        {
            ...
            public Bindings(TextLoader parent, Column[] cols, IMultiStreamSource headerFile, IMultiStreamSource dataSample)
            {
                ...
                using (var ch = parent._host.Start("Binding"))
                {
                    ...
                    if (headerFile != null)
                        Cursor.GetSomeLines(parent._host, headerFile, 1, parent.ReadMultilines, parent._separators, parent._escapeChar, ref lines);
                    if (needInputSize && inputSize == 0)
                        Cursor.GetSomeLines(parent._host, dataSample, 100, parent.ReadMultilines, parent._separators, parent._escapeChar, ref lines);
                    else if (headerFile == null && parent.HasHeader)
                        Cursor.GetSomeLines(parent._host, dataSample, 1, parent.ReadMultilines, parent._separators, parent._escapeChar, ref lines);
