...
namespace Microsoft.ML
{
    ...
    {
        /// <summary>
        /// Creates a <see cref="LightGbmRegressionTrainer"/>, which predicts a target using a gradient boosting decision tree regression model.
        /// </summary>
        ...
        /// <summary>
        /// Creates a <see cref="LightGbmRegressionTrainer"/>, which predicts a target using a gradient boosting decision tree regression model with advanced options.
        /// </summary>
        /// <param name="catalog">The <see cref="RegressionCatalog"/>.</param>
