...
namespace Microsoft.ML.LightGBM.StaticPipe
{
    ...
    public static class LightGbmStaticExtensions
    {
        ...
        /// ]]></format>
        /// </example>
        public static Scalar<float> LightGbm(this RegressionCatalog.RegressionTrainers ctx,
        ...
        /// ]]></format>
        /// </example>
        public static (Scalar<float> score, Scalar<float> probability, Scalar<bool> predictedLabel) LightGbm(this BinaryClassificationCatalog.BinaryClassificationTrainers ctx,
        ...
        /// <returns>The set of output columns including in order the predicted binary classification score (which will range
        /// from negative to positive infinity), the calibrated prediction (from 0 to 1), and the predicted label.</returns>
        public static Scalar<float> LightGbm<TVal>(this RankingCatalog.RankingTrainers ctx,
        ...
        public static (Vector<float> score, Key<uint, TVal> predictedLabel)
            LightGbm<TVal>(this MulticlassClassificationCatalog.MulticlassClassificationTrainers ctx,
            Key<uint, TVal> label,
