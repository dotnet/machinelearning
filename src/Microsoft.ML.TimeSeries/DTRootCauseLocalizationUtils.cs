...
namespace Microsoft.ML.TimeSeries
{
    public class DTRootCauseLocalizationUtils
    {
        ...
        public static PointTree BuildPointTree(List<Point> pointList, List<string> aggDims, Dictionary<string, string> subDim, string aggSymbol, bool filterByAnomaly = false) {
