...
namespace Microsoft.ML.Transforms.TimeSeries
{
    ...
    /// <summary>
    /// The <see cref="IEstimator{ITransformer}"/> for detecting a signal spike through <a href="http://arxiv.org/pdf/1206.6910.pdf">Singular Spectrum Analysis.</a> of time series.
    /// </summary>
