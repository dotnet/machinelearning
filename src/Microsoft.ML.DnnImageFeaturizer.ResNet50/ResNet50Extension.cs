...
namespace Microsoft.ML.Transforms
{
    ...
    public static class ResNet50Extension
    {
        ...
        /// </summary>
        public static EstimatorChain<ColumnCopyingTransformer> ResNet50(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string name, string source)
        {
            return ResNet50(dnnModelContext, env, name, source, Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "DnnImageModels"));
        }
        ...
        /// </summary>
        public static EstimatorChain<ColumnCopyingTransformer> ResNet50(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string name, string source, string modelDir)
        {
            ...
            var endRename = new ColumnCopyingEstimator(env, new[] { (name, "Pooling1096_Output_0") });
