...
namespace Microsoft.ML.Transforms
{
    ...
    public static class ResNet50Extension
    {
        ...
        /// </summary>
        public static EstimatorChain<ColumnCopyingTransformer> ResNet50(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string outputColumnName, string sourceColumnName)
        {
            return ResNet50(dnnModelContext, env, outputColumnName, sourceColumnName, Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "DnnImageModels"));
        }
        ...
        /// </summary>
        public static EstimatorChain<ColumnCopyingTransformer> ResNet50(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string outputColumnName, string sourceColumnName, string modelDir)
        {
            ...
            var midRename = new ColumnCopyingEstimator(env, new[] { ("Input750", "PreprocessedInput") });
            var endRename = new ColumnCopyingEstimator(env, new[] { (outputColumnName, "Pooling1096_Output_0") });
            ...
            var mainEstimator = new OnnxScoringEstimator(env, Path.Combine(modelDir, "ResNet50Onnx", "ResNet50.onnx"), new[] { "Pooling1096_Output_0" }, new[] { "Input750" });
