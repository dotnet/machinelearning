...
namespace Microsoft.ML.Legacy.Models
{
    public sealed partial class OnnxConverter
    {
        ...
        /// <list type="bullet">
        /// <item><description><c><see cref="Onnx"/></c> indicates the file to write the ONNX protocol buffer file to. This is required.</description></item>
        /// <item><description><c><see cref="Json"/></c> indicates the file to write the JSON representation of the ONNX model. This is optional.</description></item>
        /// <item><description><c><see cref="Name"/></c> indicates the name property in the ONNX model. If left unspecified, it will
        ...
        /// <item><description><c><see cref="Domain"/></c> indicates the domain name of the model. ONNX uses reverse domain name space indicators.
        /// For example com.microsoft.cognitiveservices. This is a required field.</description></item>
        /// <item><description><c><see cref="InputsToDrop"/></c> is a string array of input column names to omit from the input mapping.
        ...
        /// <item><description><c><see cref="OutputsToDrop"/></c> is similar, except for the output schema. Note that the pipeline handler
