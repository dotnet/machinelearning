...
namespace Microsoft.ML.CLI {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0} seconds was not enough to train at least one model for your dataset. Try increasing exploration time using -x option. Learn about recommended training time at https://aka.ms/cli-trainingtime.
        /// </summary>
