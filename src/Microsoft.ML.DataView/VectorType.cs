...
namespace Microsoft.ML.Data
{
    ...
    public sealed class VectorDataViewType : StructuredDataViewType
    {
        ...
        /// has length greater than one, since <see cref="VBuffer{T}"/> itself is a single dimensional sstructure,
        /// we must clarify what we mean. The indices represent a "flattened" view of the coordinates implicit in the
        /// dimensions. We consider that that last dimension is the most "minor" index. So, if you hypothetically had
