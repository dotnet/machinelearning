...
namespace Microsoft.ML.Trainers
{
    ...
    internal static class KMeansUtils
    {
        ...
        /// helper wraps some of the behavior common to parallel operations over a DataViewRowCursor set,
        /// including building the set, creating separate Random instances, and DataViewRowCursor disposal.
        /// </summary>
