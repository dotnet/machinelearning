...
namespace Microsoft.ML.Trainers.FastTree
{
    ...
    GamTrainerBase<BinaryClassificationGamTrainer.Arguments, BinaryPredictionTransformer<IPredictorProducing<float>>, IPredictorProducing<float>>
    {
        ...
        public BinaryPredictionTransformer<IPredictorProducing<float>> Train(IDataView trainData, IDataView validationData = null) => TrainTransformer(trainData, validationData);
