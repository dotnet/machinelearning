...
namespace Microsoft.ML.Trainers.FastTree.Internal
{
    ...
    {
        internal readonly RegressionTree Tree;
        ...
        internal RegressionTreeNodeDocuments(RegressionTree tree, DocumentPartitioning partitioning, int nodeIndex)
        {
            Tree = tree;
    ...
    public class RecursiveRegressionTree : RegressionTreeNodeDocuments
    {
        ...
        internal RecursiveRegressionTree(RegressionTree t, DocumentPartitioning p, int n)
            : base(t, p, n)
        {
