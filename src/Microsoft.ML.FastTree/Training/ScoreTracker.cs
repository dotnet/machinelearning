...
namespace Microsoft.ML.Trainers.FastTree.Internal
{
    public class ScoreTracker
    {
        ...
        internal void Initialize(ScoreTracker scores1, RegressionTree tree, DocumentPartitioning partitioning, double multiplier)
        {
            InitScores = null;
        ...
        internal virtual void AddScores(RegressionTree tree, double multiplier)
        {
        ...
        internal virtual void AddScores(RegressionTree tree, DocumentPartitioning partitioning, double multiplier)
        {
    ...
    public class AgdScoreTracker : ScoreTracker
    {
        ...
        internal override void AddScores(RegressionTree tree, double multiplier)
        {
            _k++;
        ...
        internal override void AddScores(RegressionTree tree, DocumentPartitioning partitioning, double multiplier)
        {
            _k++;
            double coeff = (_k - 1.0) / (_k + 2.0);
