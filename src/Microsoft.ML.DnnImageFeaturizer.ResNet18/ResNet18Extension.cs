...
namespace Microsoft.ML.Transforms
{
    ...
    public static class ResNet18Extension
    {
        ...
        /// </summary>
        public static EstimatorChain<ColumnCopyingTransformer> ResNet18(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string name, string source)
        {
            return ResNet18(dnnModelContext, env, name, source, Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "DnnImageModels"));
        }
        ...
        /// </summary>
        public static EstimatorChain<ColumnCopyingTransformer> ResNet18(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string name, string source, string modelDir)
        {
