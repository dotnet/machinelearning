...
namespace Microsoft.ML.Transforms
{
    ...
    public static class ResNet18Extension
    {
        ...
        /// </summary>
        public static EstimatorChain<ColumnCopyingTransformer> ResNet18(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string outputColumnName, string sourceColumnName)
        {
            return ResNet18(dnnModelContext, env, outputColumnName, sourceColumnName, Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "DnnImageModels"));
        }
        ...
        /// </summary>
        public static EstimatorChain<ColumnCopyingTransformer> ResNet18(this DnnImageModelSelector dnnModelContext, IHostEnvironment env, string outputColumnName, string sourceColumnName, string modelDir)
        {
