...
namespace Microsoft.ML.Trainers
{
    public abstract class EncryptedSdcaTrainerBase<TOptions, TTransformer, TModel> : StochasticTrainerBase<TTransformer, TModel>
            ...
            where TModel : class
            where TOptions : EncryptedSdcaTrainerBase<TOptions, TTransformer, TModel>.OptionsBase, new()
    {
        ...
        internal EncryptedSdcaTrainerBase(IHostEnvironment env, string featureColumnName, SchemaShape.Column labelColumn,
        ...
        internal EncryptedSdcaTrainerBase(IHostEnvironment env, TOptions options, SchemaShape.Column label, SchemaShape.Column weight = default,
        ...
        where TModelParameters : class
    {
        ...
        private protected EncryptedSdcaBinaryTrainerBase(IHostEnvironment env, BinaryOptionsBase options, ISupportSdcaClassificationLoss loss = null, bool doCalibration = false)
