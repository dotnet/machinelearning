...
namespace Microsoft.ML.Trainers
{
    ...
    /// </summary>
    public sealed class PairwiseCouplingTrainer : MetaTrainer<MulticlassPredictionTransformer<PairwiseCouplingModelParameters>, PairwiseCouplingModelParameters>
    {
