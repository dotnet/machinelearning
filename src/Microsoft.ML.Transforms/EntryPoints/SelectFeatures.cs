...
namespace Microsoft.ML.Transforms
{
    public static class SelectFeatures
    {
        [TlcModule.EntryPoint(Name = "Transforms.FeatureSelectorByCount",
            Desc = FeatureSelectionCountingTransformer.Summary,
            UserName = FeatureSelectionCountingTransformer.UserName,
        ...
        public static CommonOutputs.TransformOutput CountSelect(IHostEnvironment env, FeatureSelectionCountingTransformer.Arguments input)
        {
            ...
            var xf = FeatureSelectionCountingTransformer.Create(host, input, input.Data);
