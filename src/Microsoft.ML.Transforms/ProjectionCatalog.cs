...
namespace Microsoft.ML
{
    public static class ProjectionCatalog
    {
        ...
        public static RandomFourierFeaturizingEstimator CreateRandomFourierFeatures(this TransformsCatalog.ProjectionTransforms catalog,
            ...
            => new RandomFourierFeaturizingEstimator(CatalogUtils.GetEnvironment(catalog), name, source, newDim, useSin);
        ...
        /// </format>
        /// </example>
        public static LpNormalizingEstimator LpNormalize(this TransformsCatalog.ProjectionTransforms catalog, string name, string source =null,
            ...
            => new LpNormalizingEstimator(CatalogUtils.GetEnvironment(catalog), name, source, normKind, subMean);
        ...
        /// </format>
        /// </example>
        public static GlobalContrastNormalizingEstimator GlobalContrastNormalize(this TransformsCatalog.ProjectionTransforms catalog, string name, string source = null,
            ...
            => new GlobalContrastNormalizingEstimator(CatalogUtils.GetEnvironment(catalog), name, source, substractMean, useStdDev, scale);
