...
namespace Microsoft.ML
{
    public static class ProjectionCatalog
    {
        ...
        public static RandomFourierFeaturizingEstimator CreateRandomFourierFeatures(this TransformsCatalog.ProjectionTransforms catalog,
            ...
            => new RandomFourierFeaturizingEstimator(CatalogUtils.GetEnvironment(catalog), outputColumnName, sourceColumnName, newDim, useSin);
        ...
        /// </format>
        /// </example>
        public static LpNormalizingEstimator LpNormalize(this TransformsCatalog.ProjectionTransforms catalog, string outputColumnName, string sourceColumnName = null,
            ...
            => new LpNormalizingEstimator(CatalogUtils.GetEnvironment(catalog), outputColumnName, sourceColumnName, normKind, subMean);
        ...
        /// </format>
        /// </example>
        public static GlobalContrastNormalizingEstimator GlobalContrastNormalize(this TransformsCatalog.ProjectionTransforms catalog, string outputColumnName, string sourceColumnName = null,
            ...
            => new GlobalContrastNormalizingEstimator(CatalogUtils.GetEnvironment(catalog), outputColumnName, sourceColumnName, substractMean, useStdDev, scale);
