...
namespace Microsoft.ML.Transforms
{
    ...
    public sealed class OneHotHashEncodingEstimator : IEstimator<OneHotHashEncodingTransformer>
    {
        ...
        {
            public readonly HashingEstimator.Options HashingOptions;
            ...
            {
                HashingOptions = new HashingEstimator.Options(name, inputColumnName ?? name, numberOfBits, seed, useOrderedHashing, maximumNumberOfInverts);
