...
namespace Microsoft.ML
{
    public static class TextTransformCatalog
    {
        ...
        public static FeaturizeTextEstimator FeaturizeText(this TransformsCatalog.TextTransforms catalog,
            string inputColumn, string outputColumn = null,
            Action<FeaturizeTextEstimator.Settings> advancedSettings = null)
            => new FeaturizeTextEstimator(Contracts.CheckRef(catalog, nameof(catalog)).GetEnvironment(), inputColumn, outputColumn, advancedSettings);
        ...
        public static FeaturizeTextEstimator FeaturizeText(this TransformsCatalog.TextTransforms catalog,
            ...
            Action<FeaturizeTextEstimator.Settings> advancedSettings = null)
            => new FeaturizeTextEstimator(Contracts.CheckRef(catalog, nameof(catalog)).GetEnvironment(), inputColumns, outputColumn, advancedSettings);
    }
}
