...
namespace Microsoft.ML.Transforms
{
    ...
    //    public CountFeatureSelector(IHostEnvironment env, string inputColumn, string outputColumn = null, long count = CountFeatureSelectingEstimator.Defaults.Count)
    ...
    //    public CountFeatureSelector(IHostEnvironment env, (string input, string output)[] columns, long count = CountFeatureSelectingEstimator.Defaults.Count)
    ...
    //        return new TransformWrapper(Host, CountFeatureSelectingEstimator.Create(Host, dataview));
    //    }
    //}
    ...
    //        var dataview = copyColumn.Fit(input).Transform(input);
    //        var names = _columns.Select(x => x.output).ToArray();
    //        return new TransformWrapper(Host, MutualInformationFeatureSelectionEstimator.Create(Host, dataview, _labelColumn, _slotsInOutput, _numBins, names));
    //    }
    //}
    ...
    //        long count = CountFeatureSelectionEstimator.Defaults.Count) => new OutPipelineColumn<float>(input, count);

    //    /// <include file='doc.xml' path='doc/members/member[@name="CountFeatureSelection"]' />
    //    /// <param name="input">The column to apply to.</param>
    //    /// <param name="count">If the count of non-default values for a slot is greater than or equal to this threshold, the slot is preserved.</param>
    //    public static Vector<double> SelectFeaturesBasedOnCount(this Vector<double> input,
    //        long count = CountFeatureSelectionEstimator.Defaults.Count) => new OutPipelineColumn<double>(input, count);

    //    /// <include file='doc.xml' path='doc/members/member[@name="CountFeatureSelection"]' />
    //    /// <param name="input">The column to apply to.</param>
    //    /// <param name="count">If the count of non-default values for a slot is greater than or equal to this threshold, the slot is preserved.</param>
    //    public static Vector<string> SelectFeaturesBasedOnCount(this Vector<string> input,
    //        long count = CountFeatureSelectionEstimator.Defaults.Count) => new OutPipelineColumn<string>(input, count);
    //}
