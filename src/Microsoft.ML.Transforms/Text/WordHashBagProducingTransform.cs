...
namespace Microsoft.ML.Transforms.Text
{
    internal static class WordHashBagProducingTransformer
    {
        ...
        internal static IDataTransform Create(IHostEnvironment env, Options options, IDataView input)
        {
            ...
            return new ColumnSelectingTransformer(h, null, tmpColNames.ToArray()).Transform(view) as IDataTransform;
        }
    }
    ...
    internal static class NgramHashExtractingTransformer
    {
	    ...
	    var hashColumns = new List<HashingEstimator.ColumnInfo>();
            ...
            return new ColumnSelectingTransformer(h, null, tmpColNames.SelectMany(cols => cols).ToArray()).Transform(view) as IDataTransform;
        }
