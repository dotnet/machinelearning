...
namespace Microsoft.ML.Transforms.Text
{
    ...
    public sealed class WordBagEstimator : TrainedWrapperEstimatorBase
    {
        ...
        public WordBagEstimator(IHostEnvironment env,
            ...
            : this(env, outputColumnName, new[] { sourceColumnName ?? outputColumnName }, ngramLength, skipLength, allLengths, maxNumTerms, weighting)
        {
        }
        ...
        public WordBagEstimator(IHostEnvironment env,
            ...
            int maxNumTerms = 10000000,
            NgramExtractingEstimator.WeightingCriteria weighting = NgramExtractingEstimator.WeightingCriteria.Tf)
            : this(env, new[] { (outputColumnName, sourceColumnNames) }, ngramLength, skipLength, allLengths, maxNumTerms, weighting)
        {
        }
    ...
    public sealed class WordHashBagEstimator : TrainedWrapperEstimatorBase
    {
        ...
        /// </summary>
        /// <param name="env">The environment.</param>
        /// <param name="outputColumnName">The column containing bag of word vector. Null means <paramref name="sourceColumnName"/> is replaced.</param>
        /// <param name="sourceColumnName">The column containing text to compute bag of word vector.</param>
