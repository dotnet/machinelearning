...
namespace Microsoft.ML.Transforms.Projections
{
    public sealed class RandomFourierFeaturizingTransformer : OneToOneTransformerBase
    {
        ...
        private sealed class Mapper : OneToOneMapperBase
        {
            ...
            public Mapper(RandomFourierFeaturizingTransformer parent, DataSchema inputSchema)
            ...
            protected override DataSchema.DetachedColumn[] GetOutputColumnsCore()
            {
                ...
                for (int i = 0; i < _parent.ColumnPairs.Length; i++)
                    result[i] = new DataSchema.DetachedColumn(_parent.ColumnPairs[i].outputColumnName, _types[i], null);
                return result;
            }
