...
namespace Microsoft.ML.Transforms
{
    public sealed class RffTransform : OneToOneTransformerBase
    {
        public sealed class Arguments
        {
            ...
            public int NewDim = RandomFourierFeaturizerEstimator.Defaults.NewDim;
            ...
            public bool UseSin = RandomFourierFeaturizerEstimator.Defaults.UseSin;
    ...
    /// </summary>
    public sealed class RandomFourierFeaturizerEstimator : IEstimator<RffTransform>
    {
        ...
        /// <param name="newDim">The number of random Fourier features to create.</param>
        /// <param name="useSin">Create two features for every random Fourier frequency? (one for cos and one for sin).</param>
        public RandomFourierFeaturizerEstimator(IHostEnvironment env, string inputColumn, string outputColumn = null, int newDim = Defaults.NewDim, bool useSin = Defaults.UseSin)
            : this(env, new RffTransform.ColumnInfo(inputColumn, outputColumn ?? inputColumn, newDim, useSin))
        {
        }

        public RandomFourierFeaturizerEstimator(IHostEnvironment env, params RffTransform.ColumnInfo[] columns)
        {
            Contracts.CheckValue(env, nameof(env));
            _host = env.Register(nameof(RandomFourierFeaturizerEstimator));
            _columns = columns;
        }
    ...
    public static class RffExtenensions
    {
        ...
        private sealed class Reconciler : EstimatorReconciler
        {
                ...
                IReadOnlyDictionary<PipelineColumn, string> inputNames, IReadOnlyDictionary<PipelineColumn, string> outputNames, IReadOnlyCollection<string> usedNames)
            {
                ...
                return new RandomFourierFeaturizerEstimator(env, infos);
            }
        }
        ...
        public static Vector<float> LowerVectorSizeWithRandomFourierTransformation(this Vector<float> input,
            int newDim = RandomFourierFeaturizerEstimator.Defaults.NewDim, bool useSin = RandomFourierFeaturizerEstimator.Defaults.UseSin,
