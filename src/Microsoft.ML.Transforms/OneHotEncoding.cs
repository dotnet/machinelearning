    ...
    public sealed class OneHotEncodingEstimator : IEstimator<OneHotEncodingTransformer>
    {
        ...
        public class ColumnInfo : ValueToKeyMappingTransformer.ColumnInfo
        {
            ...
            public ColumnInfo(string name, string source = null,
                ...
                string[] term = null)
                : base(name, source ?? name, maxNumTerms, sort, term, true)
            {
        ...
        public OneHotEncodingEstimator(IHostEnvironment env, string name, string source = null,
            OneHotEncodingTransformer.OutputKind outputKind = Defaults.OutKind)
            : this(env, new[] { new ColumnInfo(name, source ?? name, outputKind) })
        {
        }
