...
namespace Microsoft.ML.TorchSharp.NasBert.Optimizers
{
    ...
    internal abstract class BaseOptimizer
    {
        ...
        public static BaseOptimizer GetOptimizer(NasBertTrainer.Options options, IEnumerable<Parameter> parameters)
        {
        ...
        protected NasBertTrainer.Options Options { get; set; }
        ...
        protected BaseOptimizer(string name, NasBertTrainer.Options options, IEnumerable<Parameter> parameters)
        {
            Name = name;
            Options = options;
