...
namespace Microsoft.ML.StaticPipe
{
    ...
    public sealed class LatentDirichletAllocationFitResult
    {
        ...
        public LatentDirichletAllocationFitResult(LatentDirichletAllocationTransformer.LdaModelParameters ldaTopicSummary)
        {
    ...
    public static class LatentDirichletAllocationStaticExtensions
    {
        private struct Config
        {
            ...
            public readonly Action<LatentDirichletAllocationTransformer.LdaModelParameters> OnFit;
            ...
            public Config(int numberOfTopics, Single alphaSum, Single beta, int samplingStepCount, int maximumNumberOfIterations, int likelihoodInterval,
                ...
                Action<LatentDirichletAllocationTransformer.LdaModelParameters> onFit)
            {
        ...
        private static Action<LatentDirichletAllocationTransformer.LdaModelParameters> Wrap(LatentDirichletAllocationFitResult.OnFit onFit)
        {
            if (onFit == null)
                return null;
