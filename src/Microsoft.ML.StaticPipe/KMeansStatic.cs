...
{
    /// <summary>
    /// The trainer context extensions for the <see cref="KMeansPlusPlusClusteringTrainer"/>.
    /// </summary>
    public static class KMeansClusteringExtensions
    {
        ...
        public static (Vector<float> score, Key<uint> predictedLabel) KMeans(this ClusteringCatalog.ClusteringTrainers catalog,
           ...
           int clustersCount = KMeansPlusPlusClusteringTrainer.Defaults.NumberOfClusters,
           Action<KMeansModelParameters> onFit = null)
        {
            ...
            {
                var options = new KMeansPlusPlusClusteringTrainer.Options
                {
                ...
                var trainer = new KMeansPlusPlusClusteringTrainer(env, options);
        ...
        public static (Vector<float> score, Key<uint> predictedLabel) KMeans(this ClusteringCatalog.ClusteringTrainers catalog,
           ...
           KMeansPlusPlusClusteringTrainer.Options options,
           Action<KMeansModelParameters> onFit = null)
        {
            Contracts.CheckValueOrNull(onFit);
