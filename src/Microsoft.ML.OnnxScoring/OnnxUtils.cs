...
namespace Microsoft.ML.OnnxScoring
{
    ...
    internal sealed class OnnxModel
    {
        ...
        public class OnnxNodeInfo
        {
            ...
            public OnnxNodeInfo(string name, long[] shape, DataType type)
            {
                Name = name;
                Shape = shape;
                Type = type;
        ...
        private static OnnxNodeInfo[] DictToNodesInfo(
            ...
            Dictionary<string, long[]> shapeDict)
        {
    ...
    internal sealed class OnnxUtils
    {
        ...
        public static Tensor CreateTensor<T>(T[] data, long[] shapeArray)
        {
            var shape = shapeArray.ToList();
