...
namespace Microsoft.ML.OnnxScoring
{
    public sealed class OnnxTransform : ITransformer, ICanSaveModel
    {
        ...
        internal sealed class IdvToTensorAdapter
        {
            ...
            private readonly long[] _onnxTensorShape;
            ...
            private ITensorValueGetter CreateTensorValueGetter<T>(IRow input, bool isVector, int colIndex, long[] tensorShape)
            {
                if (isVector)
            ...
            private class TensorValueGetterVec<T> : ITensorValueGetter
            {
                ...
                public TensorValueGetterVec(IRow input, int colIndex, long[] tensorShape)
                {
    ...
    public sealed class OnnxEstimator : TrivialEstimator<OnnxTransform>
    {
        ...
        {
            // TODO: This function never gets called during the DemoApp
            // Figure out what checks are necessary here.
