...
namespace Microsoft.ML.Internal.Utilities
{
    ...
    internal static partial class Utils
    {
        ...
        public static bool[] BuildArray(int length, IEnumerable<DataSchema.Column> columnsNeeded)
        {
        ...
        /// and for other entries not appearing in <paramref name="map"/>,
        /// <c><paramref name="invMap"/>[i] == -1</c></param>
        public static void BuildSubsetMaps(int lim, IEnumerable<DataSchema.Column> columnsNeeded, out int[] map, out int[] invMap)
        {
            Contracts.CheckParam(lim >= 0, nameof(lim));
