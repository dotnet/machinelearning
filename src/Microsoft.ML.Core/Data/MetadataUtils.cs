...
namespace Microsoft.ML.Data
{
    ...
    public static class MetadataUtils
    {
        ...
        /// <summary>
        /// Produces metadata for the predicted label column generated by trainer estimators for multiclass classification.
        /// If input LabelColumn is not available it produces slotnames metadata by default.
        /// </summary>
        /// <param name="labelColumn">Label column.</param>
        public static IEnumerable<SchemaShape.Column> MetadataForMulticlassPredLabelColumn(SchemaShape.Column? labelColumn = null)
        {
            var cols = new List<SchemaShape.Column>();
            if (labelColumn == null || (labelColumn.Value.IsKey && HasKeyValues(labelColumn.Value)))
                cols.Add(new SchemaShape.Column(Kinds.KeyValues, SchemaShape.Column.VectorKind.Vector, TextType.Instance, false));
            cols.AddRange(GetTrainerOutputMetadata());
            return cols;
        }
