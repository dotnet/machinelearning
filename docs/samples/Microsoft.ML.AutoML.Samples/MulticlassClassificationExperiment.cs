...
namespace Microsoft.ML.AutoML.Samples
{
    public static class MulticlassClassificationExperiment
    {
        ...
        private static readonly string ModelPath = @"<Desired model output directory goes here>\OptDigitsModel.zip";
        private static readonly string LabelColumnName = "Number";
