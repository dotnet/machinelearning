...
namespace Microsoft.ML.Samples.Static
{
    public class LightGbmRegressionExample
    {
        public static void LightGbmRegression()
        {
            ...
            Console.WriteLine($"L1 - {metrics.AbsoluteLoss}");    // 4.9669731
            Console.WriteLine($"L2 - {metrics.SquaredLoss}");    // 51.37296
            Console.WriteLine($"LossFunction - {metrics.LossFunction}");  // 51.37296
            Console.WriteLine($"RMS - {metrics.RootMeanSquareLoss}");              // 7.167493
