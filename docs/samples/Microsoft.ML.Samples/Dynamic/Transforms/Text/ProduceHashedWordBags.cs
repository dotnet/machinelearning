    ...
    public static class ProduceHashedWordBags
    {
        public static void Example()
        {
            ...
            var samples = new List<TextData>()
            {
                ...
                {
                    Text =
                        "This is an example to compute bag-of-word features using hashing."
                },
                new TextData()
                {
                    Text =
                        "ML.NET's ProduceHashedWordBags API produces count of n-grams and hashes it as an index into a vector of given bit length."
                },
                new TextData()
                {
                    Text =
                ...
                {
                    Text =
                        "computing n-grams and hash them to the index given by hash value."
                },
                new TextData()
                {
                    Text =
                        "The hashing reduces the size of the output feature vector"
                },
                new TextData()
                {
                    Text =
                        "which is useful in case when number of n-grams is very large."
                },
            };
