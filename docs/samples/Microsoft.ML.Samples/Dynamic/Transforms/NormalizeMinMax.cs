...
namespace Samples.Dynamic
{
    public class NormalizeMinMax
    {
        public static void Example()
        {
            ...
            // values in between.
            var normalize =
                mlContext.Transforms.NormalizeMinMax("Features", fixZero: false);
            ...
            var normalizeFixZero =
                mlContext.Transforms.NormalizeMinMax("Features", fixZero: true);
            ...
            Console.WriteLine(
                $" y = (x - ({(transformParams.Offset.Length == 0 ? 0 : transformParams.Offset[1])})) * {transformParams.Scale[1]}");
            // Expected output:
            //  The 1-index value in resulting array would be produce by: 
            //  y = (x - (-1)) * 0.3333333
        }
