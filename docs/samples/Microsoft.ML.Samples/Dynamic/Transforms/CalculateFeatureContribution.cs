...
namespace Samples.Dynamic
{
    public static class CalculateFeatureContribution
    {
        public static void Example()
        {
            ...
            Console.WriteLine(
                $"Bias: {linearModel.Model.Bias} Feature1: {linearModel.Model.Weights[0]} Feature2: {linearModel.Model.Weights[1]}");
            ...
            Console.WriteLine(
                $"Label: {prediction.Label} Prediction: {prediction.Score}");
            Console.WriteLine(
