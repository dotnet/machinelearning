    ...
    class MapKeyToVector
    {
        ...
        public static void Example()
        {
            ...
            var pipeline = mlContext.Transforms.Conversion
                .MapKeyToVector("TimeframeVector", "Timeframe")
                .Append(mlContext.Transforms.Concatenate("Parts", "PartA", "PartB"))
                .Append(mlContext.Transforms.Conversion.MapValueToKey("Parts"))
                .Append(mlContext.Transforms.Conversion.MapKeyToVector("PartsCount",
                    "Parts", outputCountVector: true))
            ...
            foreach (var featureRow in features)
                Console.WriteLine(
                    $"{featureRow.Timeframe}          {string.Join(',', featureRow.TimeframeVector.Select(x => x))}  " +
        ...
        {
            [KeyType(9)] public uint Timeframe { get; set; }
