...
namespace Samples.Dynamic
{
    public static class MapValueToArray
    {
        ...
        public static void Example()
        {
            ...
            var pipeline =
                mlContext.Transforms.Conversion.MapValue("Features", timeframeMap,
                    "Timeframe");
            ...
            IEnumerable<TransformedData> featuresColumn =
            ...
            foreach (var featureRow in featuresColumn)
                Console.WriteLine(
                    $"{featureRow.Timeframe}\t\t {string.Join(",", featureRow.Features)}");
