    ...
    public static class TextTransform
    {
        public static void Example()
        {
            ...
            var default_pipeline =
                ml.Transforms.Text.FeaturizeText(defaultColumnName, "SentimentText");
            ...
            var customized_pipeline = ml.Transforms.Text.FeaturizeText(
                customizedColumnName, new TextFeaturizingEstimator.Options
                {
                    ...
                    StopWordsRemoverOptions =
                        ...
                        }, // supports  English, French, German, Dutch, Italian, Spanish, Japanese
                }, "SentimentText");

            // The transformed data for both pipelines.
            var transformedData_default =
                default_pipeline.Fit(trainData).Transform(trainData);
            var transformedData_customized =
                customized_pipeline.Fit(trainData).Transform(trainData);
            ...
            var defaultColumn =
                transformedData_default.GetColumn<VBuffer<float>>(
                    transformedData_default.Schema[defaultColumnName]);
            ...
            var customizedColumn =
                transformedData_customized.GetColumn<VBuffer<float>>(
                    transformedData_customized.Schema[customizedColumnName]);
