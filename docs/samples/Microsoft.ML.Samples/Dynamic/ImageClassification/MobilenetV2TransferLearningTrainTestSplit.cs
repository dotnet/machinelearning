...
{
    public class MobilenetV2TransferLearningTrainTestSplit
    {
        public static void Example()
        {
            ...
            try
            {
                ...
                var pipeline = mlContext.Model.ImageClassification(
                        ...
                        // pre-trained model. 
                        arch: ImageClassificationEstimator.Architecture.MobilenetV2,
                        epoch: 10,
                        batchSize: 32,
