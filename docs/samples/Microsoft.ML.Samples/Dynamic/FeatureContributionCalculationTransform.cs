...
namespace Microsoft.ML.Samples.Dynamic
{
    public static class FeatureContributionCalculationTransform
    {
        public static void Example()
        {
            ...
            var featureContributionCalculator = mlContext.Transforms.CalculateFeatureContribution(model.Model, model.FeatureColumn, numPositiveContributions: 11, normalize: false);
            ...
            var pipeline = mlContext.Transforms.CalculateFeatureContribution(model.Model, model.FeatureColumn, numPositiveContributions: 11)
