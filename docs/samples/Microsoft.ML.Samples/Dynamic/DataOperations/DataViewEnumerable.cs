...
namespace Samples.Dynamic
{
    public static class DataViewEnumerable
    {
        ...
        public static void Example()
        {
            ...
            var rowEnumerable =
                mlContext.Data.CreateEnumerable<SampleTemperatureData>(data,
                    reuseRowObject: true);
            ...
            var rowEnumerableIgnoreMissing =
                mlContext.Data.CreateEnumerable<SampleTemperatureDataWithLatitude>(
                    data,
            ...
            foreach (var row in rowEnumerableIgnoreMissing)
                Console.WriteLine(
                    $"{row.Date.ToString("d")}\t{row.Temperature}\t{row.Latitude}");
