    ...
    public class FilterRowsByMissingValues
    {
        ...
        public static void Example()
        {
            ...
            var samples = new List<DataPoint>()
            {
                ...
                new DataPoint()
                    {Feature1 = float.NaN, Feature2 = new[] {1, 2, float.NaN}}
            };
            ...
            var filteredData =
                mlContext.Data.FilterRowsByMissingValues(data,
            ...
            var enumerable =
                mlContext.Data.CreateEnumerable<DataPoint>(filteredData,
                    reuseRowObject: true);
            ...
            {
                Console.WriteLine(
                    $"{row.Feature1}\t({string.Join(", ", row.Feature2)})");
            }
