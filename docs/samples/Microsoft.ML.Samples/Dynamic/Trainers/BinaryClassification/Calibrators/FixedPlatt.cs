...
namespace Samples.Dynamic.Trainers.BinaryClassification.Calibrators
{
    public static class FixedPlatt
    {
        public static void Example()
        {
            ...
            var data =
                Microsoft.ML.SamplesUtils.DatasetUtils.LoadFeaturizedAdultDataset(
                    mlContext);
            // Leave out 10% of data for testing.
            var trainTestData =
                mlContext.Data.TrainTestSplit(data, testFraction: 0.3);
            ...
            var outScores =
                mlContext.Data.CreateEnumerable<ScoreValue>(scoredData,
            ...
            var calibratorEstimator =
                mlContext.BinaryClassification.Calibrators.Platt(slope: -1f,
                    offset: -0.05f);
            ...
            var outScoresAndProbabilities =
                mlContext.Data.CreateEnumerable<ScoreAndProbabilityValue>(finalData,
                    reuseRowObject: false);
        ...
        private static void PrintScoreAndProbability(
            IEnumerable<ScoreAndProbabilityValue> values,
            int numRows)
        {
            foreach (var value in values.Take(numRows))
