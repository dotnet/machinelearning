...
namespace Microsoft.ML.Functional.Tests
{
    public class IntrospectiveTraining : BaseTestClass
    {
        ...
        public void InspectNestedPipeline()
        {
            ...
            var mcLrModel = (modelComponents[2] as TransformerChain<MulticlassClassificationPredictionTransformer<MulticlassLogisticRegressionModelParameters>>).LastTransformer;
        ...
        private IEstimator<TransformerChain<MulticlassClassificationPredictionTransformer<MulticlassLogisticRegressionModelParameters>>> StepTwo(MLContext mlContext)
        {
