    ...
    public sealed class ContractsCheckTest
    {
        ...
        public async Task ContractsCheck()
        {
            ...
            var expected = new DiagnosticResult[] {
                ...
                new DiagnosticResult("CS0122", DiagnosticSeverity.Error).WithLocation("Test1.cs", 752, 24).WithMessage("'ICancelableHost' is inaccessible due to its protection level"),
                new DiagnosticResult("CS0122", DiagnosticSeverity.Error).WithLocation("Test1.cs", 752, 71).WithMessage("'ICancelableHost.IsCanceled' is inaccessible due to its protection level"),
            };
