    ...
    public sealed class ContractsCheckTest
    {
        ...
        public async Task ContractsCheck()
        {
            ...
            var expected = new DiagnosticResult[] {
                ...
                new DiagnosticResult("CS0122", DiagnosticSeverity.Error).WithLocation("Test1.cs", 752, 24).WithMessage("'ICancelableEnvironment' is inaccessible due to its protection level"),
                new DiagnosticResult("CS0122", DiagnosticSeverity.Error).WithLocation("Test1.cs", 752, 78).WithMessage("'ICancelableEnvironment.IsCanceled' is inaccessible due to its protection level"),
            };
