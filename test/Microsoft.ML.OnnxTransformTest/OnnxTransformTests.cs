...
namespace Microsoft.ML.Tests
{
    public class OnnxTransformTests : TestDataPipeBase
    {
        ...
        void TestSimpleCase()
        {
            ...
            var pipe = new OnnxScoringEstimator(Env, modelFile, new[] { "softmaxout_1" }, new[] { "data_0" });
        ...
        void TestOldSavingAndLoading(int? gpuDeviceId, bool fallbackToCpu)
        {
            ...
            var est = new OnnxScoringEstimator(Env, modelFile, outputNames, inputNames, gpuDeviceId, fallbackToCpu);
        ...
        public void OnnxModelScenario()
        {
            ...
            using (var env = new ConsoleEnvironment(seed: 1, conc: 1))
            {
                ...
                var onnx = new OnnxTransformer(env, modelFile, "softmaxout_1", "data_0").Transform(dataView);
        ...
        public void OnnxModelMultiInput()
        {
            ...
            using (var env = new ConsoleEnvironment(seed: 1, conc: 1))
            {
                ...
                var onnx = new OnnxTransformer(env, modelFile, new[] { "outa", "outb" }, new[] { "ina", "inb" }).Transform(dataView);
