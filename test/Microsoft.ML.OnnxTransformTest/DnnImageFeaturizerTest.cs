...
namespace Microsoft.ML.Tests
{
    public class DnnImageFeaturizerTests : TestDataPipeBase
    {
        ...
        void TestDnnImageFeaturizer()
        {
            ...
            var pipe = new DnnImageFeaturizerEstimator(Env, m => m.ModelSelector.ResNet18(m.Environment, m.OutputColumn, m.InputColumn), "output_1", "data_0");
        ...
        public void TestOldSavingAndLoading()
        {
            ...
            var est = new DnnImageFeaturizerEstimator(Env, m => m.ModelSelector.ResNet18(m.Environment, m.OutputColumn ,m.InputColumn), outputNames, inputNames);
