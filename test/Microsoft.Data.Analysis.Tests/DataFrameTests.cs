...
namespace Microsoft.Data.Analysis.Tests
{
    public partial class DataFrameTests
    {
        ...
        public void TestOrderBy()
        {
            ...
            sortedDf = df.OrderBy("Int", nullValuesLast: false);
            ...
            sortedDf = df.OrderByDescending("Int", nullValuesLast: false);
            Assert.Null(sortedDf.Columns["Int"][0]);
            ...
            sortedDf = df.OrderBy("String", nullValuesLast: false);
            Assert.Null(sortedDf.Columns["Int"][0]);
            ...
            sortedDf = df.OrderByDescending("String", nullValuesLast: false);
            Assert.Null(sortedDf.Columns["Int"][0]);
