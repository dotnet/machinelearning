...
namespace Microsoft.ML.Runtime.RunTests
{
    ...
    public abstract partial class BaseTestPredictors : TestDmCommandBase
    {
        ...
        /// </summary>
        protected void Run(RunContext ctx, decimal precision = 10000000)
        {
        ...
        protected void RunOneAllTests(PredictorAndArgs predictor, TestDataset dataset,
            string[] extraSettings = null, string extraTag = "", bool summary = false, decimal precision = 10000000)
        {
            Contracts.Assert(IsActive);
        ...
        protected void Run_TrainTest(PredictorAndArgs predictor, TestDataset dataset,
            string[] extraSettings = null, string extraTag = "", bool expectFailure = false, bool summary = false, bool saveAsIni = false, decimal precision = 10000000)
        {
        ...
        protected void Run_CV(PredictorAndArgs predictor, TestDataset dataset,
            string[] extraSettings = null, string extraTag = "", bool useTest = false, decimal precision = 10000000)
        {
            if (useTest)
            {
