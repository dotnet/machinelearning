...
namespace Microsoft.ML.Benchmarks
{
    ...
    public class RankingTrain
    {
        ...
        {
            _mslrWeb10k_Validate = DataPath.GetDataPath(TestDatasets.MSLRWeb.validFilename);
            _mslrWeb10k_Train = DataPath.GetDataPath(TestDatasets.MSLRWeb.trainFilename);
    ...
    public class RankingTest
    {
        ...
        {
            _mslrWeb10k_Test = DataPath.GetDataPath(TestDatasets.MSLRWeb.testFilename);
            _mslrWeb10k_Validate = DataPath.GetDataPath(TestDatasets.MSLRWeb.validFilename);
            _mslrWeb10k_Train = DataPath.GetDataPath(TestDatasets.MSLRWeb.trainFilename);
