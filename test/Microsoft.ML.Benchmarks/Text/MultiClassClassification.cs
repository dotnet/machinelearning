...
namespace Microsoft.ML.Benchmarks
{
    ...
    public class MulticlassClassificationTrain
    {
        ...
        public void CV_Multiclass_WikiDetox_WordEmbeddings_SDCAMC()
        {
            ...
            var environment = EnvironmentFactory.CreateClassificationEnvironment<TextLoader, OneHotEncodingTransformer, SdcaMulticlassClassificationTrainer, LogisticRegressionMulticlassModelParameters>();
            cmd.ExecuteMamlCommand(environment);
        }
    }
