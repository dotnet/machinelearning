...
namespace Microsoft.ML.Benchmarks
{
    ...
    public class TextLoaderBench : BenchmarkBase
    {
        ...
        public void TestTextLoaderGetters()
        {
            ...
            //  Job - RRATUY : .NET Core 2.1.13(CoreCLR 4.6.28008.01, CoreFX 4.6.28008.01), X64 RyuJIT
            ...
            //  | ----------------------| ---------:| ---------:| ---------:| -------------:|
            //  | TestTextLoaderGetters | 887.3 ms  | 810.6 ms  | 44.43 ms  | -             |
            ...
            // Run time: 00:00:14(14.51 sec), executed benchmarks: 1
            //Global total time: 00:00:26(26.3 sec), executed benchmarks: 1
