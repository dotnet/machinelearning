...
namespace Microsoft.ML.Benchmarks
{
    ...
    public class StochasticDualCoordinateAscentClassifierBench : WithExtraMetrics
    {
        ...
        private TransformerChain<MulticlassPredictionTransformer<LogisticRegressionMulticlassModelParameters>> _trainedModel;
        ...
        [Benchmark]
        public TransformerChain<MulticlassPredictionTransformer<LogisticRegressionMulticlassModelParameters>> TrainIris() => Train(_dataPath);

        private TransformerChain<MulticlassPredictionTransformer<LogisticRegressionMulticlassModelParameters>> Train(string dataPath)
        {
            // Create text loader.
