...
#pragma warning disable 612, 618
    public class StochasticDualCoordinateAscentClassifierBench : WithExtraMetrics
    {
        ...
        public void TrainSentiment()
        {
            ...
            var text = new TextFeaturizingEstimator(env, "SentimentText", "WordEmbeddings", args =>
            {
            ...
            var trans = new WordEmbeddingsExtractingEstimator(env, "WordEmbeddings_TransformedText", "Features",
