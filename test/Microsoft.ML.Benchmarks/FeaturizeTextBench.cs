...
namespace Microsoft.ML.Benchmarks
{
    ...
    public class FeaturizeTextBench
    {
        ...
        public ITransformer TrainFeaturizeText()
        {
            ...
            Assert.True(memoryUsage < 1000000000, $"This benchmark should use less than 1GB of memory, but it's using {memoryUsage/1000000:0,0.00}MB"); // Memory usage should be less than 1GB after PR https://github.com/dotnet/machinelearning/pull/4576
