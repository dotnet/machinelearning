    ...
    public class CachingTests : TestDataPipeBase
    {
        ...
        public void CacheCheckpointTest()
        {
            ...
            var pipe = ML.Transforms.CopyColumns("F1", "Features")
                .Append(ML.Transforms.Normalization.Normalize("Norm1", "F1"))
                .Append(ML.Transforms.Normalization.Normalize("Norm2", "F1", Transforms.NormalizingEstimator.NormalizerMode.MeanVariance));
