...
namespace Microsoft.ML.Tests
{
    public class PermutationFeatureImportanceTests : BaseTestPredictors
    {
        ...
        private IDataView GetDenseDataset(TaskType task = TaskType.Regression)
        {
            ...
            bldr.AddColumn("X2Important", NumberDataViewType.Float, x2Array);
            bldr.AddColumn("X3", NumberDataViewType.Float, x3Array);
            bldr.AddColumn("X4Rand", NumberDataViewType.Float, x4RandArray);
