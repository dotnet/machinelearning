    ...
    public partial class TrainerEstimators : TestDataPipeBase
    {
        ...
        public void MatrixFactorizationSimpleTrainAndPredict()
        {
            ...
            if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
            {
                ...
                Assert.InRange(metrices.SquaredLoss, expectedUnixL2Error - tolerance, expectedUnixL2Error + tolerance);
            }
            ...
            else if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
            {
                ...
                Assert.InRange(metrices.SquaredLoss, expectedWindowsL2Error - tolerance, expectedWindowsL2Error + tolerance);
            }
        ...
        public void MatrixFactorizationInMemoryData()
        {
            ...
            Assert.True(metrics.SquaredLoss < 0.1);
        ...
        public void MatrixFactorizationInMemoryDataZeroBaseIndex()
        {
            ...
            Assert.InRange(metrics.SquaredLoss, 0, 0.1);
        ...
        public void OneClassMatrixFactorizationInMemoryDataZeroBaseIndex()
        {
            ...
            // Make sure the prediction error is not too large.
            Assert.InRange(metrics.SquaredLoss, 0, 0.0016);
