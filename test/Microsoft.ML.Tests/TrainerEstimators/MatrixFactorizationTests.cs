    ...
    public partial class TrainerEstimators : TestDataPipeBase
    {
        ...
        private TextLoader.Options GetLoaderArgs(string labelColumnName, string matrixColumnIndexColumnName, string matrixRowIndexColumnName)
        {
            return new TextLoader.Options()
            {
                ...
                Columns = new[]
                {
                    new TextLoader.Column(labelColumnName, ScalarType.Single, new [] { new TextLoader.Range(0) }),
                    new TextLoader.Column(matrixColumnIndexColumnName, ScalarType.UInt32, new [] { new TextLoader.Range(1) }, new KeyCount(20)),
                    new TextLoader.Column(matrixRowIndexColumnName, ScalarType.UInt32, new [] { new TextLoader.Range(2) }, new KeyCount(40)),
                }
            };
        }
