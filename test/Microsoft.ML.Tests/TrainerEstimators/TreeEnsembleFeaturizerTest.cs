    ...
    public partial class TrainerEstimators
    {
        ...
        public void TreeEnsembleFeaturizerOutputSchemaTest()
        {
...

            {
                ...
                Assert.Equal(NumberDataViewType.R4, treeValuesType.ItemType);
...

            {
                ...
                Assert.Equal(NumberDataViewType.R4, treeLeafIdsType.ItemType);
...

            {
                ...
                Assert.Equal(NumberDataViewType.R4, treePathIdsType.ItemType);
