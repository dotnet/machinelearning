...
namespace Microsoft.ML.Tests.Transformers
{
    public class ConvertTests : TestDataPipeBase
    {
        ...
        public void TestConvertWorkout()
        {
            ...
            var pipe = ML.Transforms.Conversion.ConvertType(columns: new[] {new TypeConvertingEstimator.ColumnInfo("ConvA", ScalarType.Single, "A"),
                new TypeConvertingEstimator.ColumnInfo("ConvB", ScalarType.Single, "B")});
            ...
            var allTypesPipe = ML.Transforms.Conversion.ConvertType(columns: new[] {
                new TypeConvertingEstimator.ColumnInfo("ConvA", ScalarType.Single, "AA"),
                new TypeConvertingEstimator.ColumnInfo("ConvB", ScalarType.Single, "AB"),
                new TypeConvertingEstimator.ColumnInfo("ConvC", ScalarType.Single, "AC"),
                new TypeConvertingEstimator.ColumnInfo("ConvD", ScalarType.Single, "AD"),
                new TypeConvertingEstimator.ColumnInfo("ConvE", ScalarType.Single, "AE"),
                new TypeConvertingEstimator.ColumnInfo("ConvF", ScalarType.Single, "AF"),
                new TypeConvertingEstimator.ColumnInfo("ConvG", ScalarType.Single, "AG"),
                new TypeConvertingEstimator.ColumnInfo("ConvH", ScalarType.Single, "AH"),
                new TypeConvertingEstimator.ColumnInfo("ConvK", ScalarType.Single, "AK"),
                new TypeConvertingEstimator.ColumnInfo("ConvL", ScalarType.Single, "AL"),
                new TypeConvertingEstimator.ColumnInfo("ConvM", ScalarType.Single, "AM"),
                new TypeConvertingEstimator.ColumnInfo("ConvN", ScalarType.Single, "AN")}
            );
        ...
        public void TestMetadata()
        {
            ...
            var pipe = ML.Transforms.Categorical.OneHotEncoding(new[] {
                ...
                new TypeConvertingEstimator.ColumnInfo("ConvA", ScalarType.Double, "CatA"),
                new TypeConvertingEstimator.ColumnInfo("ConvB", ScalarType.UInt16, "CatB")
            }));
            var dataView = ML.Data.ReadFromEnumerable(data);
        ...
        public void TypeConvertKeyBackCompatTest()
        {
            ...
            var modelNew = ML.Transforms.Conversion.ConvertType(new[] { new TypeConvertingEstimator.ColumnInfo("convertedKey",
                ScalarType.UInt64, "key", new KeyCount(4)) }).Fit(dataView);
