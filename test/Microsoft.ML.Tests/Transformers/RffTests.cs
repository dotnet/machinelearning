    ...
    public class RffTests : TestDataPipeBase
    {
        ...
        public void RffWorkout()
        {
            ...
            var pipe = new RandomFourierFeaturizingEstimator(Env, new[]{
                    new RandomFourierFeaturizingTransformer.ColumnInfo("RffA", "A", 5, false),
                    new RandomFourierFeaturizingTransformer.ColumnInfo("RffB", "A",10, true, new LaplacianFourierSampler.Arguments())
                });
