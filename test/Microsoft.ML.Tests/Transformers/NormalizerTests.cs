...
namespace Microsoft.ML.Tests.Transformers
{
    public sealed class NormalizerTests : TestDataPipeBase
    {
        ...
        public void SimpleConstructorsAndExtensions()
        {
            ...
            CommonUtilities.CheckSameSchemas(data1.Schema, data3.Schema);
            CommonUtilities.CheckSameSchemas(data1.Schema, data4.Schema);
            CommonUtilities.CheckSameSchemas(data1.Schema, data5.Schema);
            ...
            CommonUtilities.CheckSameSchemas(data6.Schema, data7.Schema);
            CommonUtilities.CheckSameSchemas(data6.Schema, data8.Schema);
            ...
            CommonUtilities.CheckSameSchemas(data9.Schema, data10.Schema);
            CommonUtilities.CheckSameSchemas(data9.Schema, data11.Schema);
            ...
            CommonUtilities.CheckSameSchemas(data12.Schema, data13.Schema);
            CommonUtilities.CheckSameSchemas(data12.Schema, data14.Schema);
            ...
            CommonUtilities.CheckSameSchemas(data15.Schema, data16.Schema);
            CommonUtilities.CheckSameSchemas(data15.Schema, data17.Schema);
        ...
        public void NormalizerExperimentalExtensions()
        {
            ...
            // Schema Checks
            CommonUtilities.CheckSameSchemas(data1.Schema, data6.Schema);
            CommonUtilities.CheckSameSchemas(data2.Schema, data7.Schema);
            CommonUtilities.CheckSameSchemas(data3.Schema, data8.Schema);
            CommonUtilities.CheckSameSchemas(data4.Schema, data9.Schema);
            CommonUtilities.CheckSameSchemas(data5.Schema, data10.Schema);
