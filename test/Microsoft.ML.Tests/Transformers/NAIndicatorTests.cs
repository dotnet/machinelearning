    ...
    public class NAIndicatorTests : TestDataPipeBase
    {
        ...
        public void NAIndicatorWorkout()
        {
            ...
            var pipe = new MissingValueIndicatorEstimator(Env,
                new (string name, string source)[] { ("NAA", "A"), ("NAB", "B"), ("NAC", "C"), ("NAD", "D") });
        ...
        public void NAIndicatorFileOutput()
        {
            ...
            var est = new MissingValueIndicatorEstimator(Env,
               new (string name, string source)[] { ("A", "ScalarFloat"), ("B", "ScalarDouble"), ("C", "VectorFloat"), ("D", "VectorDoulbe") });
        ...
        public void NAIndicatorMetadataTest()
        {
            ...
            var newpipe = pipe.Append(new MissingValueIndicatorEstimator(Env, new (string name, string string)[] { ("NAA", "CatA") }));
