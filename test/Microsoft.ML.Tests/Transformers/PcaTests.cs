...
namespace Microsoft.ML.Tests.Transformers
{
    public sealed class PcaTests : TestDataPipeBase
    {
        ...
        public void PcaWorkout()
        {
            ...
            var est = ML.Transforms.DimensionReduction.ProjectToPrincipalComponents("pca", "features", rank: 4, seed: 10);
            TestEstimatorCore(est, data.AsDynamic, invalidInput: invalidData.AsDynamic);

            var estNonDefaultArgs = ML.Transforms.DimensionReduction.ProjectToPrincipalComponents("pca", "features", rank: 3, exampleWeightColumnName: "weight", overSampling: 2, ensureZeroMean: false);
        ...
        public void TestPcaEstimator()
        {
            ...
            var est = ML.Transforms.DimensionReduction.ProjectToPrincipalComponents("pca", "features", rank: 5, seed: 1);
