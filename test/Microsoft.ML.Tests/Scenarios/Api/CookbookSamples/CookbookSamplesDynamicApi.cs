...
,
        ...
        public void ReadAndWriteBinaryData() 
        {
            ...
            IrisInput[] dataArray = new[]
            {
                new IrisInput { IgnoredLabel="1", PetalLength=1, SepalLength=1, PetalWidth=1, SepalWidth=1 },
                new IrisInput { IgnoredLabel="0", PetalLength=2, SepalLength=2, PetalWidth=2, SepalWidth=2 }
            };
