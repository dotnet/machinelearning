        ...
        public void PoissonRegression()
        {
            ...
            var est = reader.MakeNewEstimator()
                .Append(r => (r.label, score: ctx.Trainers.PoissonRegression(r.label, r.features, null,
                                new PoissonRegression.Arguments { L2Weight = 2, EnforceNonNegativity = true, NumThreads = 1 },
                                onFit: (p) => { pred = p; })));
        ...
        public void LogisticRegressionBinaryClassification()
        {
            ...
            var est = reader.MakeNewEstimator()
                .Append(r => (r.label, preds: ctx.Trainers.LogisticRegressionBinaryClassifier(r.label, r.features, null,
                                    new LogisticRegression.Arguments { L1Weight = 10, NumThreads = 1 }, onFit: (p) => { pred = p; })));
        ...
        public void MulticlassLogisticRegression()
        {
            ...
            var est = reader.MakeNewEstimator()
                ...
                .Append(r => (r.label, preds: ctx.Trainers.MultiClassLogisticRegression(
                    ...
                    r.features,
                    null,
                    new MulticlassLogisticRegression.Arguments { NumThreads = 1 },
                    onFit: p => pred = p)));
