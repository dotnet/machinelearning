...
namespace Microsoft.ML.StaticPipelineTesting
{
    public sealed class Training : BaseTestClassWithConsole
    {
        ...
        public void MatrixFactorization()
        {
            ...
            var reader = mlContext.Data.CreateTextReader(ctx => (label: ctx.LoadFloat(0), matrixColumnIndex: ctx.LoadKey(1, 19), matrixRowIndex: ctx.LoadKey(2, 39)), hasHeader: true);
