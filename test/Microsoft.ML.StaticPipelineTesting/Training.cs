...
namespace Microsoft.ML.StaticPipelineTesting
{
    public sealed class Training : BaseTestClassWithConsole
    {
        ...
        public void SdcaRegression()
        {
            ...
            Assert.InRange(metrics.AbsoluteLoss, 0, double.PositiveInfinity);
            Assert.InRange(metrics.SquaredLoss, 0, double.PositiveInfinity);
            Assert.InRange(metrics.RootMeanSquareLoss, 0, double.PositiveInfinity);
            Assert.Equal(metrics.RootMeanSquareLoss * metrics.RootMeanSquareLoss, metrics.SquaredLoss, 5);
        ...
        public void SdcaBinaryClassification()
        {
            ...
            Assert.InRange(metrics.AreaUnderTheCurve, 0, 1);
        ...
        public void SdcaBinaryClassificationNoCalibrationSimple()
        {
            ...
            Assert.InRange(metrics.AreaUnderTheCurve, 0.95, 1);
        ...
        public void KMeans()
        {
            ...
            Assert.InRange(metrics.AverageMinimumScore, 0.5262, 0.5264);
        ...
        public void MatrixFactorization()
        {
            ...
            Assert.InRange(metrics.SquaredLoss, 0, 0.5);
        }
