...
namespace Microsoft.ML.RunTests
{
    public partial class TestEntryPoints : CoreBaseTestClass
    {
        ...
        public void EntryPointScoring()
        {
            ...
            var lrModel = LbfgsCalibratedBinaryTrainer.TrainBinary(Env, new LbfgsCalibratedBinaryTrainer.Options { TrainingData = trainData.OutputData }).PredictorModel;
        ...
        public void EntryPointInputBuilderOptionals()
        {
            ...
            InputBuilder ib1 = new InputBuilder(Env, typeof(LbfgsCalibratedBinaryTrainer.Options), catalog);
            ...
            var instance = ib1.GetInstance() as LbfgsCalibratedBinaryTrainer.Options;
        ...
        public void EntryPointCreateEnsemble()
        {
            ...
            for (int i = 0; i < nModels; i++)
            {
                ...
                var lrInput = new LbfgsCalibratedBinaryTrainer.Options
                {
                    TrainingData = data,
                ...
                predictorModels[i] = LbfgsCalibratedBinaryTrainer.TrainBinary(Env, lrInput).PredictorModel;
                individualScores[i] =
        ...
        public void EntryPointCalibrate()
        {
            ...
            var lrModel = LbfgsCalibratedBinaryTrainer.TrainBinary(Env, new LbfgsCalibratedBinaryTrainer.Options { TrainingData = splitOutput.TestData[0] }).PredictorModel;
  ...
  ""NormalizeFeatures"": ""Yes""
        ...
        public void EntryPointLinearPredictorSummary()
        {
            ...
            var model = LbfgsCalibratedBinaryTrainer.TrainBinary(Env, lrInput).PredictorModel;
