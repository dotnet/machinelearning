...
namespace Microsoft.ML.RunTests
{
    public partial class TestEntryPoints : CoreBaseTestClass
    {
        ...
        public void EntryPointScoring()
        {
            ...
            var lrModel = LbfgsLogisticRegressionTrainer.TrainBinary(Env, new LbfgsLogisticRegressionTrainer.Options { TrainingData = trainData.OutputData }).PredictorModel;
        ...
        public void EntryPointInputBuilderOptionals()
        {
            ...
            InputBuilder ib1 = new InputBuilder(Env, typeof(LbfgsLogisticRegressionTrainer.Options), catalog);
            ...
            var instance = ib1.GetInstance() as LbfgsLogisticRegressionTrainer.Options;
        ...
        public void EntryPointCreateEnsemble()
        {
            ...
            for (int i = 0; i < nModels; i++)
            {
                ...
                var lrInput = new LbfgsLogisticRegressionTrainer.Options
                {
                    TrainingData = data,
                ...
                predictorModels[i] = LbfgsLogisticRegressionTrainer.TrainBinary(Env, lrInput).PredictorModel;
                individualScores[i] =
        ...
        public void EntryPointCalibrate()
        {
            ...
            var lrModel = LbfgsLogisticRegressionTrainer.TrainBinary(Env, new LbfgsLogisticRegressionTrainer.Options { TrainingData = splitOutput.TestData[0] }).PredictorModel;
  ...
  ""NormalizeFeatures"": ""Yes""
        ...
        public void EntryPointLinearPredictorSummary()
        {
            ...
            var model = LbfgsLogisticRegressionTrainer.TrainBinary(Env, lrInput).PredictorModel;
